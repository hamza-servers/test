...
# path = './model_scalar/'
inner = pickle.load(open('./model_scaler/inner.sav', "rb"))
outer = pickle.load(open('./model_scaler/outer.sav', "rb"))
# model_scaler\xgb_reg_1.pkl
model = pickle.load(open('./model_scaler/xgb_reg_1.pkl', "rb"))
